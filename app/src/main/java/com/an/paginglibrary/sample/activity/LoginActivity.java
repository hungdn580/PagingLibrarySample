...
import com.an.paginglibrary.sample.service.callback.CommonCallback;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (PrefWrapper.getInstance().getUser() != null) {
...
//      mAuthTask.execute((Void) null);
      ServiceBuilder.getInstance().getService().login(email, password).enqueue(new CommonCallback<UserDTO>(getBaseContext()) {
        @Override
        public void onSuccess(UserDTO user) {
          showProgress(false);
          PrefWrapper.getInstance().saveUser(new Gson().toJson(user));
          startActivity(new Intent(LoginActivity.this, MainActivity.class));
        }
